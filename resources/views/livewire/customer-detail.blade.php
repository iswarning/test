                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1"></div>
                            <label class="col-md-5">{{$customer['cmnd']}}</label>
                        </div><hr/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1"></div>
                            <label class="col-md-5">{{$customer['address']}}</label>
                        </div><hr/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1"></div>
                            <label class="col-md-5">{{$customer['household']}}</label>
                        </div><hr/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1"></div>
                            <label class="col-md-5">{{$customer['birthday']}}</label>
                        </div><hr/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5"><x-jet-button wire:click="updateShowModalCustomer({{$customer['id']}})"> Sửa </x-jet-button></div>
                        </div>
                    </div>
                </div>
                ...
                <x-jet-dialog-modal wire:model="modalShowCustomerVisible">
                    ...
                    <x-slot name="content">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6">
                                <x-jet-label for="phone" value="{{ __('Giá bán') }}" />
                ...
                <div class="tab-pane container">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-7"></div>
                                <div class="col-md-5"><x-jet-button wire:click="updateShowContract({{$row->id}})"> Sửa </x-jet-button></div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-7"></div>
                                <div class="col-md-5"><x-jet-button wire:click="updateShowPaymentAndBill"> {{ __('Sửa') }} </x-jet-button></div>
                            </div>
                            @else
                            <div class="row">
                                <div class="col-md-1"></div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-7"></div>
                                <div class="col-md-5"><x-jet-button wire:click="updateShowJuridical({{$this->juridicalData['id']}})"> {{ __('Sửa') }} </x-jet-button></div>
                            </div>
                            @else
                            <div class="row">
                                <div class="col-md-1"></div>
                            ...
                            <x-slot name="content">
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6 flex">
                                        ...
                                        <x-jet-input id="liquidation" type="checkbox" wire:model="juridicalData.liquidation" class="form-checkbox h-5 w-5 text-green-500 ml-2" checked />
